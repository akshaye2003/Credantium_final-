              ...
              <div ref={serviceSectionRef} className="mt-12 lg:mt-16 pt-12 lg:pt-16 border-t border-slate-200">
                <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
                    ...
                    <div className="space-y-6">
                      <div>
                        ...
                        <p className="text-slate-600 text-sm leading-relaxed ml-12">
                          Clutch By Cliste automatically schedules service appointments and sends confirmations across
                          all channels - website, phone, and social media, customized to your workflow
                        </p>
                      </div>
                      ...
                      <div>
                        ...
                        <p className="text-slate-600 text-sm leading-relaxed ml-12">
                          Answers questions about parts availability, pricing, and delivery times based on your
                          inventory in real-time, whether customers reach out via phone, website, or social media
                        </p>
                      </div>
                  ...
                  >
                    ...
                    <p className="text-slate-600 text-lg mb-8 leading-relaxed">
                      Stop wasting time on repetitive questions. Clutch By Cliste instantly answers common inquiries
                      about NCT, mileage, trade-ins, and pricing while qualifying serious buyers - across your website
                      widget, phone calls, and social media channels, all tailored to your dealership's specific needs.
                    </p>
